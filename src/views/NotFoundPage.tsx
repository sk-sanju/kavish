      ...
      <div className="bg-white p-8 sm:p-12 border border-[#E8DDC7] rounded-3xl shadow-xl max-w-lg w-full text-center space-y-6">
        ...
        <div className="pt-4 border-t border-[#E8DDC7] text-xs text-[#6B5846]">
          ...
          <div className="flex flex-wrap justify-center gap-3 text-[11px]">
            <button onClick={() => router.push('/shop/category/women')} className="hover:text-[#D4AF37] underline cursor-pointer">Kasavu Sarees</button>
            <span>•</span>
            <button onClick={() => router.push('/shop/category/men')} className="hover:text-[#D4AF37] underline cursor-pointer">Men's Mundu</button>
            <span>•</span>
            <button onClick={() => router.push('/track-order')} className="hover:text-[#D4AF37] underline cursor-pointer">Track Order</button>
            <span>•</span>
            <button onClick={() => router.push('/heritage')} className="hover:text-[#D4AF37] underline cursor-pointer">Our Story</button>
          </div>
        </div>
