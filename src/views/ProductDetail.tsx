    ...
    <div className="py-8 sm:py-12 bg-[#FAF8F1] animate-fadeIn pb-28 lg:pb-12">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="text-[10px] sm:text-xs text-[#6B5846] uppercase tracking-wider mb-6 sm:mb-8">
          <span className="cursor-pointer hover:underline" onClick={() => router.push('/')}>Home</span> <span className="mx-1">•</span>
          <span className="cursor-pointer hover:underline" onClick={() => router.push(`/shop/category/${product.category}`)}>{product.category}</span> <span className="mx-1">•</span>
          ...
          <div className="lg:col-span-7 flex flex-col-reverse md:flex-row gap-3 sm:gap-4">
            ...
            <div className="flex-1 aspect-[3/4] bg-[#FAF8F1] border border-[#E8DDC7] rounded-3xl overflow-hidden relative group shadow-sm">
              <OptimizedImage
                ...
                alt={`${product.name} - ${product.fabric} Atelier Weave`}
                preset="detail"
                priority={true}
                aspectRatio="3/4"
              ...
              />
              <span className="absolute top-3 left-3 sm:top-4 sm:left-4 bg-[#12372A] text-[#FAF8F1] text-[8px] sm:text-[9px] uppercase tracking-widest font-bold px-3 py-1 rounded-full border border-[#D4AF37] shadow-xs z-10">
